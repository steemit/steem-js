...
const toPrivateObj = o =>
  o ? (o.d ? o : PrivateKey.fromWif(o)) : o /*null or undefined*/;
const toPublicObj = o =>
  o ? (o.Q ? o : PublicKey.fromString(o)) : o /*null or undefined*/;
const toLongObj = o => (o ? (Long.isLong(o) ? o : Long.fromString(o)) : o);
const toBinaryBuffer = o =>
  o ? (Buffer.isBuffer(o) ? o : new Buffer(o, "binary")) : o;
