import PrivateKey from '../src/auth/protocol/types/key-private';
import Address from '../src/auth/protocol/types/address';
const assert = require('assert');
const Serilizer = require('../src/auth/protocol/serializer');
const types = require('../src/auth/protocol/types');
const ops = require('../src/auth/protocol/operations');
...
let allTypes = {
  ...
  address: Address.fromPublic(PrivateKey.fromSeed('dfhdfhdfh').toPublicKey()).toString(),
